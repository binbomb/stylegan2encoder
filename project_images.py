...
def main():
    ...
    parser.add_argument('--network-pkl', default='gdrive:networks/stylegan2-ffhq-config-g.pkl', help='StyleGAN2 network pickle filename')
    parser.add_argument('--vgg16-pkl', default='https://drive.google.com/uc?id=1o17u8qd3d8H_O1CBaWD3KMu211xtKFIn', help='VGG16 network pickle filename')
